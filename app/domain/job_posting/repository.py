...
async def create_job_posting(corporate_user: CorporateUser, data: dict) -> JobPosting:
    # JobPosting 생성
...
async def update_job_posting(job_posting: JobPosting, updated_data: dict) -> JobPosting:
